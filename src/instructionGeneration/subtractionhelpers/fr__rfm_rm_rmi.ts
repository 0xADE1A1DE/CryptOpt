...
// } from "@/types";
//
// // checks f==CF then maps to fr__f_rm_i or seto's the OF
...
// }
//
// // that will load u1 into CF, then call fr__CF_rm_rmi
...
//
//   const cinname = ra.getVarnameFromStore(cin);
//   const reg = ra.backupIfStoreHasDependencies(cin, cout);
//   ra.declareVarForFlag(Flags.CF, cinname);
//
//   ra.addToPreInstructions(`add ${reg}, -0x1; CF<-${cinname}`);
//   return fr__CF_rm_rmi(cout, out, arg0, arg1);
// }
//
