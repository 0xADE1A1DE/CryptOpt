...
\begin{tabular}{@{}lm{\resavgwidth}m{\resavgwidth}cm{\resavgwidth}m{\resavgwidth}}
    ...
    P-521       & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.20$} } & \only<3->{ \cellcolor{     blue!58 }\color{white}{$1.06$} } &  & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.25$} } & \only<3->{ \cellcolor{     blue!95 }\color{white}{$1.11$}} \\
    Poly1305    & \only<3->{ \cellcolor{     blue!94 }\color{white}{$1.10$} } & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.15$} } &  & \only<3->{ \cellcolor{     blue!79 }\color{white}{$1.09$} } & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.16$}} \\
    secp256k1   & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.34$} } & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.73$} } &  & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.32$} } & \only<3->{ \cellcolor{     blue!100}\color{white}{$1.74$}} \\
    \bottomrule
\end{tabular}
